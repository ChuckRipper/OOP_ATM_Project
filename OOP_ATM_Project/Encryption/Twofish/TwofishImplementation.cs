...
namespace OOP_ATM_Project.Encryption.Twofish
{
    public class TwofishImplementation : IDisposable
    {
        ...
        private readonly DWord[] _iv; // Initial vector

        private readonly DWord[] _key; // key bits used for encryption/decryption
        ...
        #region Reed-Solomon Fields 
        private const uint RsGfFdbk = 0x14D; //field generator
        #endregion

        #region Reed-Solomon Methods
        /// <summary>
